...
public class OidTreeNodeTest {
    ...
    public void manualfill() {
        ...
        top.add(new OidInfos(new int[] {1}, "iso"));
        top.add(new OidInfos(new int[] {1, 1}, "std"));
        top.add(new OidInfos(new int[] {1, 1, 8802}, "iso8802"));
        top.add(new OidInfos(new int[] {1, 1, 8802, 1}, "ieee802dot1"));
        top.add(new OidInfos(new int[] {1, 1, 8802, 1}, "ieee802dot1"));
        top.add(new OidInfos(new int[] {1, 1, 8802, 1, 1}, "ieee802dot1mibs"));
        top.add(new OidInfos(new int[] {1, 1, 8802, 1, 1, 1}, "ieee8021paeMIB"));
        top.add(new OidInfos(new int[] {1, 1, 8802, 1, 1, 1, 2}, "dot1xPaeConformance"));
        top.add(new OidInfos(new int[] {1, 2}, "member-body"));
